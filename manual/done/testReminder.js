...
const middayMessages = [
  `📖 Rise and shine, Verba! Today's the day — meeting at **3:00 PM GMT**: ${EVENT_LINK}`,
];
const hourMessages = [
  `⏳ One hour until Verba convenes! **3:00 PM GMT**: ${EVENT_LINK}`,
];
const fifteenMessages = [
  `@everyone 🚨 15 minutes to go! Join us: ${EVENT_LINK}`,
];
...
client.once('clientReady', () => {
  ...
  console.log(
    'Waiting for 17:42 (midday), 17:43 (hour), 17:44 (fifteen) UTC...'
  );
