...
const fifteenMinMessages = [
  `@everyone 🚨 15 minutes to go! Grab your seat before Verba begins — this is the part where you stop scrolling and start joining: ${EVENT_LINK}`,
  `@everyone 📖 Final call — meeting starts in 15 minutes, and yes, we've saved you a spot. Come claim it: ${EVENT_LINK}`,
  `@everyone ⏰ Quick, close whatever tab you're procrastinating on — we start in 15, and it's always more fun with a full room: ${EVENT_LINK}`,
  `@everyone 🍃 15 minutes till the pages turn and the conversation starts. Don't make us start without you: ${EVENT_LINK}`,
  `@everyone ✨ Almost showtime — 15 minutes left, and there's still time to grab your tea and join the fun: ${EVENT_LINK}`,
  `@everyone 🪶 The feather's about to drop — 15 minutes to go, and we promise it's worth logging on for: ${EVENT_LINK}`,
  `@everyone 📚 Last call for latecomers — 15 minutes and counting, come say hi and bring a quote: ${EVENT_LINK}`,
  `@everyone 🌟 15 minutes till we open the book together — come be part of the story instead of just reading about it: ${EVENT_LINK}`,
  `@everyone 🔔 Ding ding! 15 minutes till we begin, and every seat's better with you in it: ${EVENT_LINK}`,
  `@everyone 🎬 Places, everyone — we're rolling in 15 minutes, don't miss your cue: ${EVENT_LINK}`,
  `@everyone 🫖 15 minutes left — just enough time to pour your tea and settle into your favorite spot before we begin: ${EVENT_LINK}`,
  `@everyone 🕯️ Almost time. 15 minutes till this little corner fills up with warm voices — come find your place: ${EVENT_LINK}`,
  `@everyone 🧸 15 minutes and counting — grab your blanket, your book, and come be cozy with us: ${EVENT_LINK}`,
  `@everyone 🌷 So close now — just 15 minutes till we're all together. We've been looking forward to this: ${EVENT_LINK}`,
  `@everyone 📔 15 minutes left to gather your thoughts and your favorite lines — we can't wait to hear them: ${EVENT_LINK}`,
  `@everyone 🌤️ Almost there — 15 minutes until familiar faces and soft conversation. Come as you are: ${EVENT_LINK}`,
  `@everyone 🍯 15 sweet minutes left before we begin — settle in, we've saved you a seat: ${EVENT_LINK}`,
  `@everyone 🧡 Just 15 minutes now, and already so glad you're here. See you in a moment: ${EVENT_LINK}`,
  `@everyone 🕊️ 15 minutes to go — a gentle little nudge that your warm corner is almost ready for you: ${EVENT_LINK}`,
  `@everyone 🍁 15 minutes left — find your cozy spot, we're so close to starting: ${EVENT_LINK}`,
  `@everyone 🌙 Almost time to curl up together — 15 minutes until we begin, see you soon: ${EVENT_LINK}`,
  `@everyone 🧵 15 minutes left before we start trading favorite lines like little gifts — come join us: ${EVENT_LINK}`,
  `@everyone 🌼 15 minutes to go — whatever your day's been, this is about to be the soft part of it: ${EVENT_LINK}`,
  `@everyone 📖 15 minutes left until we open our books and our hearts a little — we'll be waiting: ${EVENT_LINK}`,
  `@everyone 🕰️ Just 15 more minutes — grab your tea, take a breath, you're already welcome here: ${EVENT_LINK}`,
];
